...
foreach ($suite in @('medical','police','dispatch','licenses','evidence','mdt','restart','all')) { if ($text -notmatch [regex]::Escape($suite)) { throw "Missing emergency runtime suite $suite" } }
