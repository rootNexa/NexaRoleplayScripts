...
NEXA_PERMISSIONS.catalog = {
    ...
    { name = 'nexa.admin.warn.view', category = 'admin', label = 'View Warnings' },
    { name = 'nexa.admin.warn.revoke', category = 'admin', label = 'Revoke Warnings', critical = true },
    ...
    { name = 'nexa.admin.ban.view', category = 'admin', label = 'View Bans' },
    ...
    { name = 'nexa.admin.notes.edit', category = 'admin', label = 'Edit Admin Notes', critical = true },
    { name = 'nexa.admin.notes.delete', category = 'admin', label = 'Delete Admin Notes', critical = true },
...
NEXA_PERMISSIONS.rolePermissions = {
    ...
    head_admin = {
        ...
        'nexa.admin.notes.edit',
        'nexa.admin.notes.delete',
